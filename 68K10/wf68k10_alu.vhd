...
begin
    ...
    P_OTHERS: process(ADR_MODE, ALU_COND_I, BIW_0, BIW_1, OP, OP1, OP2, OP1_SIGNEXT, OP_SIZE)
    ...
    COND_CODES: process(BIW_1, BITPOS, CB_BCD, CHK_CMP_COND, CLK, OP1, OP1_SIGNEXT, OP2, OP2_SIGNEXT,
                        ...
                        RESULT_OTHERS, SHIFT_WIDTH, STATUS_REG, VFLAG_DIV, XFLAG_SHFT, X_IN)
    ...
    begin
        ...
        case OP is
            ...
            when DIVS =>
                if OP_SIZE = LONG and OP1 = x"00000000" then
                    XNZVC <= X_IN & "0100";
                elsif OP_SIZE = WORD and OP1(15 downto 0) = x"0000" then
                    XNZVC <= X_IN & "0100";
                elsif VFLAG_DIV = '1' then
                    XNZVC <= X_IN & "1010";
                else
